...
public class Maze33 {
    ...
    public static void main(String[] args) {
        paramsPanel = new JFrame("Maze ver. 3.3");
    ...
    public static class MazePanel extends JPanel {
        ...
        public MazePanel(int width, int height) {
            ...
            JLabel programer = new JLabel("Προγραμματιστής: Νίκος Κανάργιας  ver. 3.3", JLabel.CENTER);
            ...
            terminateWhenTargetInClosedSet = new
                    JCheckBox("Τερματισμός όταν ο στόχος είναι στις κλειστές καταστάσεις");
            ...
            // ρυθμίζουμε τα μεγέθη και τις θέσεις τους
            message.setBounds(15, height-159, width-30, 23);
            robot.setBounds(15, height-100, (width-50)*5/20, 23);
            target.setBounds(15+(width-60)*5/20, height-100, (width-60)*5/20, 23);
            frontier.setBounds(15, height-80, (width-60)*5/20, 23);
            closed.setBounds(15+(width-60)*5/20, height-80, (width-60)*5/20, 23);
            clearButton.setBounds(15, height-130, (width-60)*10/20, 28);
            stepButton.setBounds(30+(width-60)*10/20, height-130, (width-60)*6/20, 28);
            animationButton.setBounds(30+(width-60)*10/20, height-95, (width-60)*6/20, 28);
            dfs.setBounds(45+(width-60)*16/20+5, height-140, (width-60)*4/20+10, 28);
            bfs.setBounds(45+(width-60)*16/20+5, height-120, (width-60)*4/20+10, 28);
            aStar.setBounds(45+(width-60)*16/20+5, height-100, (width-60)*4/20+10, 28);
            greedy.setBounds(45+(width-60)*16/20+5, height-80, (width-60)*4/20+10, 28);
            dijkstra.setBounds(45+(width-60)*16/20+5, height-60, (width-60)*4/20+10, 28);
            velocity.setBounds(30+(width-60)*10/20, height-70, (width-60)*6/20, 23);
            slider.setBounds(30+(width-60)*10/20, height-53, (width-60)*6/20, 23);
            diagonal.setBounds(15, height-57, (width-60)*10/20, 23);
            terminateWhenTargetInClosedSet.setBounds(15, height-35, width-30, 23);
