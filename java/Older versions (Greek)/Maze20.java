 ...
 * Με βάση τις παραμέτρους του δημιουργού της κλάσης MazePanel υπολογίζονται
    ...
    public static class MazePanel extends JPanel {
        ...
        private final static int
            SQUARE_SIZE = 12,  // Το μέγεθος του κελιού σε pixels
                               ...
                               // πάντως άρτια και όχι μικρότερη από 12 αν θέλουμε να
        ...
        public MazePanel(int width, int height) {
            ...
            programer = new JLabel("Προγραμματιστής: Νίκος Κανάργιας  ver. 2.0", JLabel.CENTER);
        ...
        private void expandNode(){
            ...
            expanded++;
            // Εδώ έχουμε το 4ο βήμα των αλγορίθμων
            ...
            //    Στην περίπτωση των αλγορίθμων DFS και BFS οι διάδοχοι δεν πρέπει
            //    να ανήκουν ούτε στις ΑΝΟΙΚΤΕΣ ούτε στις ΚΛΕΙΣΤΕΣ.
            ArrayList<Cell> succesors = createSuccesors(current);
            // Εδώ έχουμε το 5ο βήμα των αλγορίθμων
            ...
            for (Cell cell: succesors){
                ...
                // Διαφορετικά ...
                    ...
                    // ... αν τρέχουμε τον ΒFS ...
                        ...
                        // Ενημέρωσε το χρώμα του κελιού
                        room[cell.row][cell.col] = FRONTIER;
                    // ... αν τρέχουμε τον Α* (Βήμα 6 αλγορίθμου Α*) ...
        ...
        private ArrayList<Cell> createSuccesors(Cell current){
            ...
            // Αν επιτρέπονται διαγώνιες κινήσεις θα πρέπει να προσθέσουμε άλλους
            // τέσσερες πιθανούς διαδόχους
            if (diagonal.isSelected()){
