 ...
 *
 * Unable to change the position of obstacles, robot and target, as well as the
 * search algorithm, while the search is underway.
 * 
    ...
    public class MazePanel extends JPanel {
        ...
        private class AboutBox extends JDialog{
            ...
            public AboutBox(boolean modal){
                ...
                JLabel version = new JLabel("Version: 4.1.2", JLabel.CENTER);
                ...
                JLabel link = new JLabel("<html><a href=\\\"\\\">https://www.dropbox.com/sh/3tl3vmsd8ebxo24/xKmjl8uXX7</a></html>", JLabel.CENTER);
                link.setCursor(new Cursor(Cursor.HAND_CURSOR));
                link.setFont(new Font("Helvetica",Font.PLAIN,16));

                JLabel video = new JLabel("<html><a href=\\\"\\\">Watch demo video at YouTube</a></html>", JLabel.CENTER);
                ...
                video.     setBounds(5,155, 430, 20);
                dummy.     setBounds(5,180, 430, 20);
            }
            ...
            private void goYouTube(JLabel video) {
                video.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        try {
                            Desktop.getDesktop().browse(new URI("http://youtu.be/CLbqqb53DLA"));
                        } catch (URISyntaxException | IOException ex) {
                            //It looks like there's a problem
                        }
                    }
        ...
        /**
          * Gives initial values â€‹â€‹for the cells in the grid.
